...
L'actionneur principal du *PAMI* est conçu pour la manipulation rapide et sécurisée des caisses de noisettes. Pour maximiser l'efficacité lors des matchs, nous avons opté pour un système de préhension par le vide monté sur un *bras articulé*.

## 2. Architecture mécanique 

Le système se compose d'un bras à segment, permettant une grande liberté de mouvement tout en restant dans le périmètre de départ du PAMI.
